...
class CLTObserver:
    ...
    def observe_leaves(self,
        ...
        if give_pruned_clt:
            # Collapse the tree
            collapsed_clt = CollapsedTree.collapse_same_ancestral(clt)
            collapsed_clt = CollapsedTree.collapse_identical_leaves(collapsed_clt)
            obs_evts_list = []
            tree_evts = []
            ...
            return list(observations.values()), collapsed_clt, clt
        else:
