...
from simulation import AlleleTree, Allele, AlleleForest
from collapsed_tree import CollapsedTree

true_tree_file = "out.pkl"
with open(true_tree_file, "r") as f:
    true_allele_tree = (pickle.load(f)).trees[0]
print true_allele_tree.tree
print true_allele_tree.collapsed_tree.tree
...
for t in trees:
    ...
    rf_res = collapsed_est_tree.robinson_foulds(
        true_allele_tree.collapsed_tree.tree, unrooted_trees=True)
