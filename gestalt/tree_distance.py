...
class InternalCorrMeasurer(MRCADistanceMeasurer):
    ...
    def get_dist(self, tree):
        ...
        print("REF LEAF GROUP", self.ref_leaf_groups)
        print("REF1", self.ref_node_val)
        print("VAL1", tree_node_val1)
        ...
        print("tree leaf _groups", tree_leaf_groups2)
        ref_node_val2 = self.get_compare_node_distances(self.ref_tree, tree_leaf_groups2)
        print("REF2", tree_node_val2)
        print("VAL2", ref_node_val2)
